...

{
	...
	["life_inv_cordlessScrewdriver",life_inv_cordlessScrewdriver],
	["life_inv_roadBarrierSmall",life_inv_roadBarrierSmall],
	["life_inv_roadCone",life_inv_roadCone],
	["life_inv_arrowSignLeft",life_inv_arrowSignLeft],
	["life_inv_arrowSignRight",life_inv_arrowSignRight],
	["life_inv_portableLight",life_inv_portableLight],
	["life_inv_drugtester",life_inv_drugtester]
];
