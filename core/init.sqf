...
[] call compile PreprocessFileLineNumbers "core\nosidechat.sqf";
...
player setVariable["restrainedByCiv",false,true];
...
// Dialbed Player Tag: LIFE_ID_PlayerTags = ["LIFE_PlayerTags","onEachFrame","life_fnc_playerTags"] call BIS_fnc_addStackedEventHandler;
