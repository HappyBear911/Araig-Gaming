...
switch(playerSide) do {
	case west: {
		...
		__CONST__(life_swatlevel,parseNumber(_this select 10));
...
switch(__GETC__(life_donator)) do
{
	...
	case 3: {life_paycheck = life_paycheck + 800;};
	case 4: {life_paycheck = life_paycheck + 1600;};
	case 5: {life_paycheck = life_paycheck + 3200;};
};
