...
if(life_cash < life_ticket_val) exitWith
{
	...
	[[1,format["%1 has paid for the Ticket.",player getVariable["realname",name player]]],"life_fnc_broadcast",life_ticket_cop,false] spawn life_fnc_MP;
...
[[getPlayerUID player],"life_fnc_wantedRemove",false,false] spawn life_fnc_MP;
hint format["You've paid for the ticket in the amount of $%1",[life_ticket_val] call life_fnc_numberText];
closeDialog 0;
[[0,format[localize "STR_Cop_Ticket_PaidNOTF",profileName,[life_ticket_val] call life_fnc_numberText]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
