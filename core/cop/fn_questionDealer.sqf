...
if (life_cash < 5000) exitWith {hint "Du hast nicht genug Bargeld dabei um den Dealer zu bestechen!"};
...
_names = "";
{
	...
	[[_x select 0,_x select 1,"36"],"life_fnc_wantedAdd",false,false] spawn life_fnc_MP;
