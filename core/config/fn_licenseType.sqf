...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "obstler": {_var = "license_civ_obstler"};
			case "distwater": {_var = "license_civ_distwater"};
			case "sugarcanejuice": {_var = "license_civ_sugarcanejuice"};
			case "mash": {_var = "license_civ_mash"};
			case "rum": {_var = "license_civ_rum"};
			case "sugar": {_var = "license_civ_sugar"};
			case "drinkwater": {_var = "license_civ_drinkwater"};
			default {_var = ""};
		};
	};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_mushroom": {_var = "mushroom"}; 
			case "license_civ_obstler": {_var = "obstler"}; 
			case "license_civ_distwater": {_var = "distwater"}; 
			case "license_civ_sugarcanejuice": {_var = "sugarcanejuice"}; 
			case "license_civ_mash": {_var = "mash"}; 
			case "license_civ_rum": {_var = "rum"}; 
			case "license_civ_sugar": {_var = "sugar"}; 
			case "license_civ_drinkwater": {_var = "drinkwater"}; 
			default {_var = ""};
		};
	};
};
