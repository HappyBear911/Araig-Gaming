...
switch (_vehicle) do
{
	case "C_Offroad_01_F" :
	{
		switch (_index) do
		{
			...
			case 6: {_color = "Black"};
			case 7: {_color = "Cop"};
			case 8: {_color = "HighLife"};
			case 9: {_color = "Sticker"};
			case 10: {_color = "Rasta"};
			case 11: {_color = "Medic"};
			case 12: {_color = "Pink Camo"};
		};
	};
	...
	case "C_SUV_01_F":
	{
		switch (_index) do
		{
			...
			case 2: {_color = "Orange";};
			case 3: {_color = "Creeper";};
			case 4: {_color = "Batman";};
			case 5: {_color = "Rattlesnake";};
			case 6: {_color = "Cop";};
			case 7: {_color = "Black";};
			case 8: {_color = "Cyber Girl";};
		};
	};
