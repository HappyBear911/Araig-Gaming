...
switch (_var) do
{
	...
	case "life_inv_mushroomu": {"Mushroom"};
	case "life_inv_mushroomp": {"Magic Mushroom"};
	case "life_inv_obstler": {"Schnapps"};	
	case "life_inv_springwater": {"Spring Water"}; 
	case "life_inv_distwater": {"Distilled Water"}; 
	case "life_inv_drinkwater": {"Drinking Water"}; 
	case "life_inv_sugarcane": {"Sugar Cane"}; 
	case "life_inv_sugarcanejuice": {"Sugar Cane Juice"}; 
	case "life_inv_sugar": {"Sugar"}; 
	case "life_inv_mash": {"Mash"}; 
	case "life_inv_rum": {"White Rum"};	
	case "life_inv_roadBarrier": {"Barrier"};
	case "life_inv_cordlessScrewdriver": {"Cordless Screwdrivers"};
	case "life_inv_roadBarrierSmall": {"Barrier (small)"};
	case "life_inv_roadCone": {"Pylons"};
	case "life_inv_arrowSignLeft": {"Direction sign (left)"};
	case "life_inv_arrowSignRight": {"Direction sign (right)"};
	case "life_inv_portableLight": {"Headlights"};
	case "life_inv_drugtester": {"Drug Tests"};	
	case "life_inv_kidney": {"Black Market kidney"}; 
	case "life_inv_scalpel": {"Scalpel"}; 
	case "life_inv_speedbomb": {"Speed Bomb"};
	case "life_inv_tankmanipulator": {"Tank Manipulator"};
	...
	case "license_civ_mushroom": {"Mushroom Stock"};
	case "license_civ_obstler": {"Schnapps license"};	
	case "license_civ_distwater": {"Distilling License"};
	case "license_civ_sugarcanejuice": {"Sugarcane Juice License"};
	case "license_civ_mash": {"Mash License"};
	case "license_civ_rum": {"Rum License"};
	case "license_civ_sugar": {"Sugar License"};
	case "license_civ_drinkwater": {"Drinking Water License"};	
};
