...
// Send message to cops that player is now on Wanted List
[[1,format["%1 is wanted.",name _unit,_amount,getPlayerUID _unit]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
