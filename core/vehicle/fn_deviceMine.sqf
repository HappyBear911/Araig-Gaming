...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","lead_1","iron_1","salt_1","sand_1","diamond_1","oil_1","oil_2","rock_1","mushroom_1","sugarcane_1","springwater_1"];
_zone = "";
...
_item = switch(true) do {
	...
	case (_zone in ["mushroom_1"]): {"mushroomu"};
	case (_zone in ["sugarcane_1"]): {"sugarcane"};
	case (_zone in ["springwater_1"]): {"springwater"};
	default {""};
};
