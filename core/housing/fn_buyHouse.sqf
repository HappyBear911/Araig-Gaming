...
//if(count life_houses >= (__GETC__(life_houseLimit) + 1) && __GETC__(life_donator) > 2) exitWith {hint format["You can only own %1 houses at a time.",__GETC__(life_houseLimit) + 1]};
closeDialog 0;
